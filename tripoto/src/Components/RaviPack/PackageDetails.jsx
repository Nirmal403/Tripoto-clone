...
import { getSinglePackageData } from '../Redux/AppRedux/action';

import { useSelector } from 'react-redux/es/hooks/useSelector';
import styles from "./PackageDetails.module.css";
import PackageDetailsBottom from '../Ravi/PackageDetailsBottom';
...
const PackageDetails = () => {
    ...
    const single = useSelector((state) => state.AppRedux.singleData);
    // console.log(id);
